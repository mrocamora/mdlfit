...
Encode a music dataset from a corpus provided by music21.
...
def encode_dataset_from_string(dataset_string, signature='4/4', beat_subdivisions=2,
    ...
    ----------
    dataset_string : str
        name of the dataset as defined in music21
    ...
    print(__doc__)
    print('-'*80)
    print('Corpus name (music21): ', dataset_string)
...
def process_arguments(args):
    ...
    parser.add_argument('dataset_string',
                        action='store',
                        help='name of the dataset as defined in music21 (e.g. airdsAirs, '\
                        'oneills1850, EssenFolksong)')
